...
const SocketHandler = (req, res) => {
  if (!res.socket.server.io) {
    ...
    io.on('connection', (socket) => {
      ...
      socket.on('joinRoom', ({ roomCode, playerName = "Player1", isHost, maxPlayers = MAX_PLAYERS }) => {
  console.log('Received joinRoom event for room:', roomCode, 'from player:', playerName);
        ...
        console.log(`Emitting room code: ${roomCode}`);
        socket.emit('roomCode', roomCode); // Emit the room code to the client
